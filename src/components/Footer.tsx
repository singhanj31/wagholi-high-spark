        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-10 items-start">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-4">
              <img src={gsLogo} alt="GS Group" className="h-14 w-auto brightness-200" />
              <img src={whsLogo} alt="Wagholi High Street" className="h-12 w-auto brightness-200" />
            </div>
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center gap-2 text-sm text-primary-foreground/70">
              ...
              <a href="mailto:singh31anj@gmail.com" className="hover:text-gold transition-colors">singh31anj@gmail.com</a>
            </div>
            <div className="flex items-center gap-2 text-sm text-primary-foreground/70">
