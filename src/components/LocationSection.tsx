    ...
    <section id="location" className="section-padding bg-background relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-start">
          ...
          >
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1891.0!2d74.017861!3d18.573787!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bc2c147b80a6883%3A0xa2c9e1f3b1d4e77f!2sGS+Crown+Plaza!5e0!3m2!1sen!2sin!4v1700000000000!5m2!1sen!2sin"
              width="100%"
              height="100%"
              style={{ border: 0 }}
              allowFullScreen
